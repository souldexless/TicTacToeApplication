...
public class TicTacToeApplication {
	...
	public static void main(String[] args) {
		...
		while (doYouWantToPlay) {
			...
			System.out.println("Welcome to Tic Tac Toe! You are about to go against the master of" + 
					"Tic Tac Toe.  Are you ready?  I hope so!" +
					"But first you must pick what character you want to be and which character" + 
					" I will be");
			...
			//Set up the game
			System.out.println();
			System.out.println("Now we can star the game.  TO play, enter a number and your token shall be " +
			...
			System.out.println("Do you want to play again? Enter Y if you do. Enter anything else" + 
